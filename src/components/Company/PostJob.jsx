...
export default function PostJob() {
  ...
  const fetchJobs = async () => {
    try {
      setLoading(true);
      const res = await axios.get(`http://localhost:3000/api/jobs/getJobsByEmployer/${userId}`, {
  ...
  expLevel: formData.experience, // updated key
  location: formData.location,
  requiredSkills: formData.skills, // updated key
  jobDescription: formData.description, // updated key
  expiresAt: new Date("2025-12-31T23:59:59.000Z"), // added field
  employerId: userId, // keeping this if your backend needs employer identification
};


      const res = await axios.post("http://localhost:3000/api/employers/jobs/createJob", payload, {
        headers: { Authorization: `Bearer ${token}` },
      });
      ...
      <div className="flex-1 px-10 py-10 overflow-y-auto">
        ...
        >
          <div className="flex items-center justify-between mb-8">
            <h1 className="text-4xl font-bold text-gray-800">Posted Jobs</h1>
