...
// Dummy Button and Card Components (replace with your UI components if available)
  ...
  return (
    <div className="max-w-2xl mx-auto p-6">
      ...
      >
        ...
        >
          <select className="px-4 py-2 rounded-lg bg-gray-100 border border-gray-300 text-gray-800">
            <option>Dark</option>
            <option>Light</option>
          </select>
        </SettingCard>
